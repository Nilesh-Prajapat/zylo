    ...
    <div className="mx-auto w-full max-w-2xl px-4 py-6 sm:px-6">
      ...
      <div className="mb-6 flex items-center gap-3">
        ...
        <div>
          <h1 className="text-xl font-extrabold text-zylo-text">
            {targetUser?.displayName || targetUser?.username || 'User'}&apos;s Followers
          </h1>
          <p className="text-xs text-zylo-muted">People following this user</p>
        </div>
      </div>
      ...
      {loading ? (
        ...
        <div className="rounded-3xl border border-zylo-border bg-white p-12 text-center shadow-xs">
          ...
          <h3 className="mt-3 text-sm font-bold text-zylo-text">No followers yet</h3>
          <p className="mt-1 text-xs text-zylo-secondary">This account does not have any followers right now.</p>
        </div>
      ) : (
