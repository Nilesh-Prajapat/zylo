  ...
  return (
    <Link href={`/stream/${stream.id}`} className="group block">
      <div className="relative aspect-[1.55/1] overflow-hidden rounded-2xl bg-zylo-soft border border-zylo-border/60 shadow-xs">
        ...
        {isScheduled && (
          <div className="absolute left-2.5 top-2.5 flex items-center gap-1.5">
            <span className="flex items-center gap-1 rounded-md bg-amber-500 px-2 py-0.5 text-[10px] font-black text-black shadow">
      ...
      <div className="mt-2.5 px-0.5">
        ...
        {isScheduled && (
          <p className="mt-0.5 text-[10px] font-bold text-amber-600 truncate">
